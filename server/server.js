...
app.post('/api/inject-crisis', async (req, res) => {
    try {
        ...
        res.json({ success: true, eventId: data.event?.id, message: "Datadog event created successfully." });
    } catch (error) {
