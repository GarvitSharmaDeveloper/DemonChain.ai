...
export const mockNewsData: Record<string, NewsArticle> = {
  "Taiwan Warehouse": {
    ...
    raw_article_text:
      "A catastrophic Category 5 Super Typhoon has made direct landfall on Taiwan's western coast. Wind speeds exceeding 160 mph and severe flooding have forced the emergency shutdown of all major semiconductor fabrication plants in the Hsinchu Science Park. Port authorities in Kaohsiung have also halted all outbound cargo ships. Industry experts expect complete production halts for at least 7 days, causing massive downstream bottlenecks for consumer electronics heading to North America.",
    imageUrl:
    ...
    parsedData: {
      ...
      impactAssessment:
        "Emergency shutdown of semiconductor plants. Port outbound cargo halted. Downstream bottlenecks expected.",
  ...
  "Singapore Hub": {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1586345542291-e2fa6e4a0f65?q=80&w=1200&auto=format&fit=crop",
    imageAlt: "Aerial view of Singapore shipping port",
    parsedData: {
      eventType: "Technology - IT Malfunction",
      impactAssessment:
        "Automated crane assignments stalled for 6 hours. Backlog of outbound freighters to clear in 24 hours.",
