    ...
    <div className="newspaper-container">
      ...
      <main className="single-article-spread">
        ...
        <div className="article-meta">
          ...
          <span>—</span>
          <span>
            {article.location_details.origin_city},{" "}
            {article.location_details.origin_country}
          </span>
        </div>
        ...
        <div className="single-image-container">
          ...
          <p className="image-caption">
            {article.imageAlt} (Photo: Dispatch Archive)
          </p>
        </div>
        ...
        <div className="scraper-data" data-event-id={article.id}>
          <span
            data-origin={`${article.location_details.origin_city}, ${article.location_details.origin_country}`}
          ></span>
          <span
            data-impacted-routes={article.location_details.impacted_routes_to.join(
              ";",
            )}
          ></span>
        </div>
