      ...
      <div className="fake-notification">
        ...
        <div className="notification-content">
          ...
          <div className="notification-title">
            CRITICAL: Supply Chain Anomaly
          </div>
          <div className="notification-body">
            Risk Score threshold exceeded. 14-day shipment delay predicted for
            NY Apple Store components. Automatic Slack & PagerDuty alerts
            triggered.
          </div>
          <div className="notification-actions">
            <button className="action-btn primary" onClick={handleAcknowledge}>
              Acknowledge
            </button>
            <button className="action-btn" onClick={handleRunbook}>
              View Runbook
            </button>
          </div>
        </div>
