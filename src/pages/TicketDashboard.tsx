...
const TicketDashboard: React.FC<TicketDashboardProps> = ({
    ...
    const generateMitigation = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:3001/api/generate-mitigation",
          {
            method: "POST",
  ...
  const delayDays =
    crisisConfig.severity === "Critical"
      ? 14
      : crisisConfig.severity === "High"
        ? 8
        : 3;

  return (
    <div
      className="page-layout ticket-layout"
      ...
      <div className="ticket-header-card glass-panel">
        <div className="ticket-header-main">
          <div>
            ...
            <h1 className="ticket-title">
              Supply Chain Disruption: {crisisConfig.type} at{" "}
              {crisisConfig.location}
            </h1>
          </div>
        ...
        <div className="ticket-meta-grid">
          ...
          <div className="meta-item">
            ...
            <span className="meta-value" style={{ color: severityColor }}>
              {crisisConfig.severity}
            </span>
          </div>
          <div className="meta-item">
            <span className="meta-label">
              <Clock size={14} /> Est. Delay
            </span>
      ...
      <div className="ticket-content-grid">
        ...
        <div className="ticket-main-col">
          <div className="ticket-section glass-panel">
            <h2>
              <Users size={18} /> Stakeholders Notified
            </h2>
          ...
          <div className="ticket-section glass-panel">
            ...
            <div className="incident-description">
              <p>
                <strong>System Detection:</strong> ChainLink Global AI parsed a
                critical alert regarding a {crisisConfig.type} impacting
                operations at the {crisisConfig.location}.
              </p>
              <p>
                <strong>Impact Assessment:</strong>{" "}
                {crisisConfig.impactAssessment ||
                  "Significant delays expected across all outbound freight lines."}
              </p>
        ...
        <div className="ticket-sidebar">
          <div className="ticket-section glass-panel runbook-section">
            ...
            {!isGenerating && parsedMitigationSteps.length > 0 && (
              <button
                className="execute-runbook-btn alert-pulse"
          ...
          <div className="ticket-section glass-panel">
            ...
            >
              <button className="secondary-action-btn">
                <Share2 size={14} /> Share Ticket via Slack
              </button>
              <button
