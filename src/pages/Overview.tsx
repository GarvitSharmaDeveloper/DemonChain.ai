    ...
    return (
        <div className="page-layout" style={{ position: 'relative' }}>
            ...
            <div className="left-panel">
                <div className="page-header" style={{ borderBottom: '1px solid var(--color-border)', paddingBottom: '1.5rem', flexShrink: 0 }}>
                    <h2 style={{ fontSize: '1.5rem', marginBottom: '0.25rem' }}>Global Supply Chain Topology</h2>
                    <p style={{ fontSize: '0.9rem' }}>Status: Healthy. No predicted disruptions.</p>
                </div>
            ...
            {showModal && (
                <div className="modal-overlay">
                    <div className="modal-content slide-up">
                        ...
                        <p className="modal-subtitle">Choose a region to simulate an AI-detected supply chain disruption.</p>
                        ...
                        <div className="form-group" style={{ marginBottom: '2rem' }}>
                            ...
                            >
                                <option value="Taiwan Warehouse">Taiwan Warehouse (Critical)</option>
                                <option value="India Port">India Port (Medium)</option>
                                <option value="Singapore Hub">Singapore Hub (Low)</option>
                            </select>
                        </div>

                        <button className="launch-btn alert-pulse" onClick={handleLaunch} style={{ width: '100%', display: 'flex', justifyContent: 'center', gap: '0.5rem' }}>
                            <Play size={20} />
                            Launch Simulation
                        </button>
                    </div>
